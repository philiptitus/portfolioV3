  ...
  return (
    <section className="relative w-full px-12 pt-6 pb-12 lg:px-24 lg:pt-10 lg:pb-16">
      <div className="flex flex-col items-center text-center">
        ...
        {/* Bottom headline: SHIP. -- Geist Pixel Grid */}
        <motion.h1
          initial={{ opacity: 0, y: 30, filter: "blur(8px)" }}
          animate={{ opacity: 1, y: 0, filter: "blur(0px)" }}
        ...
        >
          Philip Titus | Software Engineer | ML Engineer | DevOps Specialist. Building scalable systems, intelligent models, and exceptional digital experiences.
        </motion.p>
